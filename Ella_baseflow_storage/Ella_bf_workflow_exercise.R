...
commandArgs <- function(...){
  c("LurayEvent.csv", "obs_date", "obs_flow", "Luray", "LurayBF.csv", "monitoring_location_id")
}
...
commandArgs <- function(...){
  c("01634000", "watershed", "usgs_full_drainage", "agwrc-1.0", 'simple_lm', "LurayAGWRCRegression.csv")
}
