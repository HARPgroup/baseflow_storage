...
# args for example
args[1] <- paste0("https://raw.githubusercontent.com/HARPgroup/baseflow_storage/refs/heads/ben_trimming/bf_events_01634000.csv")
args[2] <- paste0("forN51187")
args[3] <- paste0("01634000")
...
ggplot(data = event_sums, mapping = aes(x=remainder, y = (AGWET_tot)))+
  ...
  ggtitle("Remainder and Event total ET - ", site_num)+
