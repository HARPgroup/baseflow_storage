...
## Put plots in function?


# Plot 1, scatter plot of Actual vs. Predicted
p1 <- ggplot(FlowResults, aes(x = start_date)) +
...
# Calculate Residuals
Residual_7day = FlowResults$pred_7day - FlowResults$observed_7day

# Plot 2, scatter plot of Residuals and baseline y = 0
p2 <- ggplot(FlowResults, aes(start_date, Residual_7day)) +
...
# Plot 1, scatter plot of Actual vs. Predicted
p1 <- ggplot(FlowResults, aes(x = start_date)) +
  geom_point(aes(y = actual_15day, color = "Actual"), size = 1.3) +
  geom_point(aes(y = flow_15day, color = "Predicted"), size = 1.3) +
  labs(title = "Predicted vs. Actual Flow in Baseflow Events (15-Day Period)", y = "Flow (cfs)", x = "Date", color = "Flow")+
  theme_classic()

# Calculate Residuals
Residual_15day = FlowResults$flow_15day - FlowResults$actual_15day
