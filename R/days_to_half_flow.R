qs <- list("0.999 (693-day half-flow)" = 1.0*(0.999^(1:90)))
qs[["0.9924 (90-day)"]] <- 1.0*(0.9924^(1:90))
qs[["0.985 (45-day)"]] <- 1.0*(0.985^(1:90))
qs[["0.977 (30-day)"]] <- 1.0*(0.977^(1:90))
qs[["0.965 (20-day)"]] <- 1.0*(0.965^(1:90))
qs[["0.95 (14-day)"]] <- 1.0*(0.95^(1:90))
qs[["0.90 (6-day)"]] <- 1.0*(0.90^(1:90))
